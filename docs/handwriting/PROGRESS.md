...
最后更新：2026-09-25。M0 已完成（[0003](changes/0003-m0-baseline.md)），M1/M2 已完成（[0004](changes/0004-m1-panel-reorganization.md)、[0005](changes/0005-m2-brush-model.md)，同提交），M3–M5 进行中。
...
| M3 个人预设 | 部分完成 | 逻辑模块 `handwriting/brushPresets.ts` 已就绪（43 项测试，随 M1/M2 提交入库）；CRUD/导入导出 UI 未做 |
