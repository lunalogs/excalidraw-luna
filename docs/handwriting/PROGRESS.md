...
最后更新：2026-09-25。M0 已完成（见 [0003](changes/0003-m0-baseline.md)），M1–M5 尚未开始实现；下方“已交付”仅指第一阶段代码和本轮规划。
...
| M1 左上面板与独立文件入口 | 未开始 | 当前页面仍为第一阶段左下面板 |
| M2 四参数笔刷模型 | 未开始 | 当前钢笔/荧光笔只是基础预设，尚无四参数控制 |
| M3 个人预设 | 未开始 | 保存、CRUD 与预设备份待实现 |
